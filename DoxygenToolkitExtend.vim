...
function! s:getFileType()
  if( &filetype == "python" )
    ...
    elseif (strridx(l:fileName,".sh")>0)
      let l:fileType = "shell"
    elseif (strridx(l:fileName,".te")>0)
      let l:fileType = "shell"
...
function! <SID>Annotate()
 call InitAnnotate()
  ...
  let l:line=s:type."-".s:operate." by (".g:DoxygenToolkit_authorName."),".l:date
...
function! <SID>AnnotateBegin()
  ...
  let l:line=s:type."-".s:operate."-"."BEGIN"." by (".g:DoxygenToolkit_authorName."),".l:date
...
function! <SID>AnnotateEnd()
  ...
  let l:line=s:beginTag.s:type."-".s:operate."-"."END "." by (".g:DoxygenToolkit_authorName.")".s:endTag
  exec "normal o".l:line
endfunction
...
function! s:segmentate(reason,beginTag,endTag,LINE_LENGTH)
  ...
  let l:hight=l:contentLength/l:shouldLength
	...
	let l:line=""
      ...
      let l:old_fmtopt=&formatoptions
      set formatoptions=tcq
      exec "normal o".l:line.a:endTag
      let &formatoptions=l:old_fmtopt
      let l:i=l:i+1
      endwhile
endfunction
